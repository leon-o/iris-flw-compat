...
public class IrisProgramLinker extends ProgramLinker {
    ...
    protected Optional<ProgramSource> getProgramSourceReference(ProgramSet programSet, String flwShaderName, boolean isShadow, boolean isEmbedded, boolean crumbling){
